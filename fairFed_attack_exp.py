...
from attacks.fed_avg_inversion_attack_Exp import train_and_attack_fed_avg
from models.fully_connected_exp import FullyConnected 
...
def calculate_fed_avg_local_dataset_inversion_performance(architecture_layout, dataset, max_client_dataset_size,
    ...
    # ---Chirag Collecting data here--maybe
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_samples', type=int, default=2,help='Set the number of MC samples taken for each experiment')
